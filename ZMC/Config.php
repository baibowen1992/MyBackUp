...
class ZMC_Config extends ZMC_Registry
{
	...
	public function __construct($overridesFromZmcDotPhp = null)
	{
		...
		parent::__construct(array(
			...
			'email_address' => 'support@wocloud.cn', 
			'email_notify' => false, 
			'sql_time_limit' => 300, 
			...
			'links' => array(
				'download'	=> 'http://' . $overridesFromZmcDotPhp['zn_host'] . '.wocloud.cn/index.php?redirect=download.php&username=' . $_SESSION['zmanda_network_id'],
				'feedback'	=> 'http://www.wocloud.cn/feedback.php?feature=' . ZMC::escape(str_replace(' ', '_', $overridesFromZmcDotPhp['name'])) . '&email='
					. ZMC::escape($_SESSION['zmanda_network_id']) . "&r=$overridesFromZmcDotPhp[amanda_svn_info]",
				'home'		=> 'http://' . $overridesFromZmcDotPhp['zn_host'] . '.wocloud.cn/index.php?redirect=home.php&username=' . $_SESSION['zmanda_network_id'],
				'shopping'	=> 'http://' . $overridesFromZmcDotPhp['zn_host'] . '.wocloud.cn/index.php?redirect=/shop/home.php?cat=1,3&username=' . $_SESSION['zmanda_network_id'],
				'support'	=> 'http://' . $overridesFromZmcDotPhp['zn_host'] . '.wocloud.cn/index.php?redirect=support.php',
			),
			'locale_sort'	=> 'C', 
			'log_slow_queries' => true, 
			'lore'			=> 'http://network.wocloud.cn/lore/article.php?id=',
			'low_memory'	=> 0.75, 
			...
			'support_email' => '<a href="mailto:support@wocloud.cn">support@wocloud.cn</a>',
			'support_email_txt' => 'Please contact Support at support@wocloud.cn.',
			'support_email_html' => 'Please contact Support at <a href="mailto:support@wocloud.cn">support@wocloud.cn</a>.',
			'svn_overlay' => '',
			...
			'url_zn_auth' => 'https://' . $overridesFromZmcDotPhp['zn_host'] . '.wocloud.cn/WebServices/authenticate.php',
			'user_registry' => 'files', 
			'ultra_turbo' => false, 
			'use_cache' => true, 
			'verify_installed_files' => true,
			'verbose_logs' => true, 
			'wiki'			=> 'http://docs.wocloud.cn/',
