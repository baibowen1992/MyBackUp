...
<div id="lsscsiWindow" class="wocloudRightWindow" style='width:45%; background-color:white;'>
	<? ZMC::titleHelpBar($pm, 'Changer/Tape Unit Details'); ?>
	<div class="wocloudContentContainer tabbedNavigation" style="height:22px;">
		<ul>
...
</div><!-- lsscsiWindow wocloudRightWindow -->
