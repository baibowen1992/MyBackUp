 ...
 // $Id: wocloud-utils.js 40320 2014-06-25 10:11:41Z qtran $ */
		...
		if(ac.value === '0'){
			...
			if(!gebi('msgBoxWarnings_customApp')){ //the warning message hasn't been added
				var warningMsg = "A dumptype named  \"zmc_&#60;CUSTOM APPLICATION&#62;_app\" must be defined in<br>" +
					"/etc/amanda/&#60;CONFIG NAME&#62;/zmc_backupset_dumptypes.<br>Please contact Support for more information."
				var htmlStr = "<div class=\"wocloudMessages wocloudUserWarnings\" id=\"msgBoxWarnings_customApp\" style=\"float:left\">" + 
					"<div class=\"wocloudMsgBox\" onclick=\"this.parentNode.style.display='none'\">X</div>" +
					"<div class=\"wocloudMsgWarnErr\"><img onclick=\"this.parentNode.style.display='none'\" " +
					"style=\"cursor:pointer\" src=\"/images/global/calendar/icon_calendar_warning.gif\" " +
					"alt=\"Warnings\">&nbsp;"+ warningMsg + "</div></div>"
				gebi('wocloudMessageBox0').innerHTML += htmlStr
			}
		} else {
			...
			if(customAppWarnMsg) //delete the custom application warning message
				gebi('wocloudMessageBox0').removeChild(customAppWarnMsg)
		}
	}
}
...
YAHOO.register("wocloud-utils", YAHOO.zmc.utils, {version: "2.9.0", build: "$Revision: 40320 $".substr(11,5)})
