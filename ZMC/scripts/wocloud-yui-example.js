 ...
 // $Id: wocloud-yui-example.js 35641 2013-02-25 21:33:37Z anuj $ */
...
YAHOO.register("wocloud-yui-example", YAHOO.zmc.example, {version: "2.5.2", build: "$Revision: 35641 $".substr(10,5)})
d=new Date();
alert('wocloud-yui-example.js: loaded ok '+d.toTimeString());
