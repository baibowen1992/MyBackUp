 ...
 // $Id: zmc-messagebox.js 35641 2013-02-25 21:33:37Z anuj $ */

YAHOO.namespace('zmc.messageBox');
YAHOO.zmc.messageBox =
{
map:{
		instructions:"zmcUserInstructions",
		escapedInstructions:"zmcUserInstructions",
		messages:"zmcUserMessages",
		escapedMessages:"zmcUserMessages",
		warnings:"zmcUserWarnings",
		escapedWarnings:"zmcUserWarnings",
		errors:"zmcUserErrors",
		escapedErrors:"zmcUserErrors",
		internals:"zmcUserInternalErrors",
		escapedInternals:"zmcUserInternalErrors",
		details:"zmcUserDetails",
		escapedDetails:"zmcUserDetails"
},
...
isEmpty:function()
{
	...
	var messageBox = gebi('zmcMessageBox0');
	var noInstructions = (YAHOO.util.Dom.getElementsByClassName("instructions", null, messageBox, null).length == 0);
	var noUserErrors = (YAHOO.util.Dom.getElementsByClassName("zmcUserErrors", null, messageBox, null).length == 0);
	var noProgramErrors = (YAHOO.util.Dom.getElementsByClassName("zmcUserWarnings", null, messageBox, null).length == 0);
...
renderRestException:function(level, message)
{
	...
	output += '<div id="errorDetails" class="zmcUserDetails" style="display:none">'+message+'</div>';
	...
	if (fields.length == 8) //the pretty message is in position 8 (7 0 indexed)
		...
		messageBox.innerHTML += '\
			<div class="' + YAHOO.zmc.messageBox.map[type] + '">\
				<div onclick="this.parentNode.style.display=\'none\';" class="zmcMsgBox">X</div>\
					<div class="zmcMsgWarnErr" style="">\
...
YAHOO.register("zmc-messagebox", YAHOO.zmc.messageBox, {version: "2.9.0", build: "$Revision: 35641 $".substr(11,5)})
